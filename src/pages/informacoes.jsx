                    ...
                    <div className="col-lg-10">
                        ...
                        <div className="">
                            ...
                            <div className="list-group">
                                ...
                                <a href="#" className="list-group-item list-group-item-action"><strong>Característica do mercado de desenvolvimento:</strong> <br />
                                    <ArrowRight className="ms-2 text-primary" size={18} /> Ausência de conselhos regionais regulamentadores formalizados <br />
                                    <ArrowRight className="ms-2 text-primary" size={18} /> Profissionais com diversas formações atuando no mercado <br />
                                    <ArrowRight className="ms-2 text-primary" size={18} /> Grandes oportunidades para empreendedorismo<br />
                                    <ArrowRight className="ms-2 text-primary" size={18} /> Alta competitividade técnica <br/>
                        ...
                        <footer className="text-center mt-5">
                            <p className="small text-muted">Desenvolvido com React, JS e Bootstrap</p>
                        </footer>
                    </div>
                </div>
            </div>
